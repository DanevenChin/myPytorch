...
class ToAbsoluteCoords(object):
    """convert bbox from percentage of image size to original size
    Args:
        img: numpy array
    ...
    def __call__(self, image, boxes = None, labels = None):
        ...
        while True:
            ...
            for _ in range(50):
                ...
                if overlap.min() < min_iou and max_iou < overlap.max(): continue
...
class SSDAugmentation(object):
    def __init__(self, img_size=300, mean=(0, 0, 0)):
        self.mean = mean
